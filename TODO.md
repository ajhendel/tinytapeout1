...
2. [~] **Trial P&R** (in progress 2026-08-26, see docs/AREA_GATE.md) — one fabric site + one calibration macro through OpenLane/LibreLane against sky130. Real cells/site number replaces the estimate in docs/THROUGHPUT.md. Verify keep/dont_touch survives the TT flow and that a deliberate combinational loop passes. (Docker, light-compute limits on the Mac, or a cheap cloud box.)
